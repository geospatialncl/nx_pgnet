...
-- Trigger: ni_check_record_geometry_columns_table_post_graph_edges_update on "Graphs"

-- DROP TRIGGER ni_check_record_geometry_columns_table_post_graph_edges_update ON "Graphs";
...
-- Trigger: ni_check_record_geometry_columns_table_post_graph_insert on "Graphs"

-- DROP TRIGGER ni_check_record_geometry_columns_table_post_graph_insert ON "Graphs";
...
-- Trigger: ni_check_record_geometry_columns_table_post_graph_nodes_update on "Graphs"

-- DROP TRIGGER ni_check_record_geometry_columns_table_post_graph_nodes_update ON "Graphs";
...
-- Trigger: ni_delete_edges_geometry_table_post_delete_graph on "Graphs"

-- DROP TRIGGER ni_delete_edges_geometry_table_post_delete_graph ON "Graphs";
...
-- Trigger: ni_delete_edges_table_post_delete_graph on "Graphs"

-- DROP TRIGGER ni_delete_edges_table_post_delete_graph ON "Graphs";
...
-- Trigger: ni_delete_global_int_record_post_graph_record_delete on "Graphs"

-- DROP TRIGGER ni_delete_global_int_record_post_graph_record_delete ON "Graphs";
...
-- Trigger: ni_delete_int_tables_post_delete_graph on "Graphs"

-- DROP TRIGGER ni_delete_int_tables_post_delete_graph ON "Graphs";
...
-- Trigger: ni_delete_nodes_table_post_delete_graph on "Graphs"

-- DROP TRIGGER ni_delete_nodes_table_post_delete_graph ON "Graphs";
...
-- Trigger: ni_delete_record_geometry_columns_table_post_delete_graph on "Graphs"

-- DROP TRIGGER ni_delete_record_geometry_columns_table_post_delete_graph ON "Graphs";
