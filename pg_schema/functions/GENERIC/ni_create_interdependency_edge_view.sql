-- Function: ni_create_interdependency_edge_view(character varying, character varying, character varying, integer, integer)

-- DROP FUNCTION ni_create_interdependency_edge_view(character varying, character varying, character varying, integer, integer);
