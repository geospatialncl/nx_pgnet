...
CREATE OR REPLACE FUNCTION ni_get_all_table_column_names(varchar, varchar, varchar, varchar)
    RETURNS varchar AS
$BODY$
DECLARE
     --schema name
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION ni_get_all_table_column_names(varchar, varchar, varchar, varchar) OWNER TO postgres;
