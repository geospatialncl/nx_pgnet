-- Function: ni_edge_geometry_equality_check(character varying, character varying, integer)

-- DROP FUNCTION ni_edge_geometry_equality_check(character varying, character varying, integer);
