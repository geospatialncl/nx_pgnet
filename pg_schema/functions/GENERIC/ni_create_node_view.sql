-- Function: ni_create_node_view(character varying, character varying, character varying, integer, integer)

-- DROP FUNCTION ni_create_node_view(character varying, character varying, character varying, integer, integer);
