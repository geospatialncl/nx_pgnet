-- Function: ni_node_attribute_equality_check(character varying, character varying, anyelement)

-- DROP FUNCTION ni_node_attribute_equality_check(character varying, character varying, anyelement);
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION ni_node_attribute_equality_check(character varying, character varying, anyelement) OWNER TO postgres;
