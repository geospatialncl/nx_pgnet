-- Function: ni_get_all_view_column_names(character varying, character varying, character varying, character varying)

-- DROP FUNCTION ni_get_all_view_column_names(character varying, character varying, character varying, character varying);

CREATE OR REPLACE FUNCTION ni_get_all_view_column_names(character varying, character varying, character varying, character varying)
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION ni_get_all_view_column_names(character varying, character varying, character varying, character varying) OWNER TO postgres;
